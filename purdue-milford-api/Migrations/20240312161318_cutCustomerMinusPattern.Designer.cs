...
namespace dg_foods_api.Migrations
{
    ...
    [Migration("20240312161318_cutCustomerMinusPattern")]
    partial class cutCustomerMinusPattern
    {
            ...
            modelBuilder.Entity("dg_foods_api.Models.ProductCutsModel", b =>
                {
                    ...
                    b.Property<string>("cut1")
                        .IsRequired()
                        .HasColumnType("TEXT");

                    b.Property<string>("cut2")
                        .IsRequired()
                        .HasColumnType("TEXT");
