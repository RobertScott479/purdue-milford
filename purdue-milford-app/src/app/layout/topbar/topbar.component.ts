...
import { QcService } from '../../reports/trimline/qc/qc.service';
...
export class TopbarComponent implements OnInit {
  ...
  constructor(public homeService: HomeService, public authService: AuthService, public qcService: QcService) {}
  ...
  get qcLoggedIn(): boolean {
    return this.qcService.activeChecker.cutter_number > 0;
  }
}
